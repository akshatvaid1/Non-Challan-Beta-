...
export default function Fleet({ isLoading = false }: FleetProps) {
  ...
  return (
    <section id="fleet-section" className="py-12 md:py-24 bg-gray-50 scroll-mt-20 md:scroll-mt-24 w-full">
      <div className="w-full px-6 md:px-10">
        <div className="bg-white rounded-2xl p-6 md:p-10 shadow-sm min-h-[400px] flex flex-col w-full">
          {/* Title section */}
          <div className="text-center mb-8 md:mb-12">
            <h2 className="text-2xl md:text-4xl font-semibold text-gray-900">Choose Your Rental Shop</h2>
            <p className="text-gray-500 text-base md:text-lg leading-relaxed mt-2">Compare trusted rental shops near your campus and book instantly.</p>
          </div>
          ...
          {isLoading ? (
            <div className="flex-1 flex items-center justify-center">
              <div className="flex flex-col items-center gap-4">
                ...
                <p className="text-gray-400 font-medium italic text-sm md:text-base">Loading premium fleet...</p>
              </div>
            </div>
          ) : !hasData ? (
            <div className="flex-1 flex items-center justify-center border-2 border-dashed border-gray-100 rounded-xl bg-gray-50/50 py-12 md:py-20">
              <div className="text-center px-4">
                ...
                <p className="text-gray-500 mt-1 text-sm md:text-base">Please check back later for new arrivals.</p>
              </div>
            </div>
          ) : (
            /* Grid layout */
